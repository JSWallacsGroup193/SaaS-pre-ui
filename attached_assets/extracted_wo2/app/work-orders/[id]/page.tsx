...
import type { WorkOrderDetail, WorkOrderStatus } from "@/types/work-order"
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <WorkOrderDetailHeader
        ...
        onEdit={() => console.log("[v0] Edit clicked")}
        onPrint={() => console.log("[v0] Print clicked")}
        onDelete={() => console.log("[v0] Delete clicked")}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-6">
          ...
          <div className="lg:sticky lg:top-6 lg:self-start">
            <WorkOrderSidebar
              ...
              onReassign={() => console.log("[v0] Reassign clicked")}
              onReschedule={() => console.log("[v0] Reschedule clicked")}
              onGenerateInvoice={() => console.log("[v0] Generate invoice clicked")}
              onSendUpdate={() => console.log("[v0] Send update clicked")}
              onMarkComplete={() => console.log("[v0] Mark complete clicked")}
